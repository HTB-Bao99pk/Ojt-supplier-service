        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <span
                className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold ${renderStatus(supplier.status)}`}
              >
                {supplier.status}
              </span>
            </div>
        ...
        <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-lg border-gray-300 bg-gray-50 p-2 text-sm text-gray-700 outline-none focus:border-blue-500"
            >
              ...
              {products.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  <td className="px-4 py-3">
                    ...
                    >
                      {item.productId}{" "}
                      <span className="rounded bg-blue-50 px-1 py-0.5 text-[10px]">
                        Compare
                      </span>
                    </Link>
                  </td>
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`rounded-full px-2 py-1 text-xs font-medium ${item.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                    >
            ...
            <form onSubmit={handleUpdateProduct} className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="number"
                  className="mt-1 w-full rounded-lg border p-2"
                  value={editingProduct.deliveryDateTimes}
                  onChange={(e) =>
                    setEditingProduct({
                      ...editingProduct,
                      deliveryDateTimes: e.target.value,
                    })
                  }
                  required
                />
