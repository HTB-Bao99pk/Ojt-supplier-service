...
export default function UpdateProduct() {
    ...
    const [supplierId, setSupplierId] = useState(null); // API update cần biết supplierId
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setSaving(true);
            // Chuẩn bị dữ liệu gửi đi (convert số)
            const payload = {
            ...
            // Gọi API (truyền supplierId lấy từ lúc get detail, productId từ url)
